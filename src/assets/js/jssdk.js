...
/**
 * jssdk 1.6.0 commonjs
 * @author maybe
 * @update 2020年4月27日 17:10:00
 */
! function (e, n) {
  module.exports = n(e)
}(window, function (o, e) {
                        ...
                        h.appId = v.appId,
                          ...
                          w.getNetworkType({
                            ...
                            success: function (e) {
                              ...
                              const n = "https://open.weixin.qq.com/sdk/report?v=" + h.version + "&o=" + h.isPreVerifyOk + "&s=" + h.systemType + "&c=" + h.clientVersion + "&a=" + h.appId + "&n=" + h.networkType + "&i=" + h.initTime + "&p=" + h.preVerifyTime + "&u=" + h.url;
                              i.src = n
                            }
                          })
                      }
